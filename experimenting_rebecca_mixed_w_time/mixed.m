...
for T_arterial = 30 %32.3:37.3 %run through different arterial blood temperatures
...
figure(2)
title({'CBF vs Time for 300g Healthy Tissue + 200g Ischemic Tissue';'Ischemic CBF = 30 ml/min/100g'});
ylabel('CBF (ml/min)');
xlabel('time (min)');
legend('Perfusate temperature = 30','Perfusate temperature = 33.3', 'Perfusate temperature = 34.3', 'Perfusate temperature = 35.3', 'Perfusate temperature = 36.3', 'Perfusate temperature = 37.3');

figure(3)
title({'CMR vs Time for 300g Healthy Tissue + 200g Ischemic Tissue';'Ischemic CBF = 30 ml/min/100g'});
ylabel('CMR (umol02/min)');
xlabel('min');
legend('Perfusate temperature = 30','Perfusate temperature = 33.3', 'Perfusate temperature = 34.3', 'Perfusate temperature = 35.3', 'Perfusate temperature = 36.3', 'Perfusate temperature = 37.3');

figure(4)
title({'Heat Washout (dQ) vs Time for 300g Healthy Tissue + 200g Ischemic Tissue';'Ischemic CBF = 30 ml/min/100g'});
