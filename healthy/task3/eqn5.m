function dtemp = eqn5(t, temp, T_arterial, base_cbf, base_cmr)
...
[cbf, cmr] = CBF_CMR_calculator_give_pars(temp, base_cbf, base_cmr);
...
dtemp = ((H0-Hb)*cmr - p_blood*c_blood*cbf*(temp-T_arterial))/c_tissue; %dtemp/dt = delC/min