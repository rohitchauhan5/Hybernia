...
figure(2)
title('CBF vs Time for 500g Healthy Tissue with Perfusate Temps 32.3-37.3 deg C');
ylabel('CBF (ml/min)');
xlabel('time (min)');
...
figure(3)
title('CMR vs Time for 500g Healthy Tissue with Perfusate Temps 32.3-37.3 deg C');
ylabel('CMR (umol02/min)');
xlabel('min');
legend('Perfusate temperature = 32.3','Perfusate temperature = 33.3', 'Perfusate temperature = 34.3', 'Perfusate temperature = 35.3', 'Perfusate temperature = 36.3', 'Perfusate temperature = 37.3');

figure(4)
title('Heat Washout (dQ) vs Time for 500g Healthy Tissue with Perfusate Temps 32.3-37.3 deg C');
